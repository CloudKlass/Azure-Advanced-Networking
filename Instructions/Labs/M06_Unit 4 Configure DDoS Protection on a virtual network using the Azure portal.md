...
1. On the **Virtual network name** box, type **MyVirtualNetwork**. 
...
1. In the menu, under **Settings**: Select **DDos protection**.

1. Next to **DDos Network Protection**: Select **Enable**
...
1. Select **myResourceGroup** from the list.
...
1. On the **Create alert rule** page: Select the **Scope** tab and delete the current entry.

1. click on **+ Select scope**

1. On the **Select a resource** pane, in the **Resource types** drop down list box. In **Filter Items**: Type **Public IP addresses**.
...
1. On the **Signal name** drop down list: Select **Under DDoS attack or not**.
